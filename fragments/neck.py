...
def yolov4_neck(input_shapes):
    ...
    spp = tf.keras.layers.Concatenate()([maxpool_4, maxpool_3, maxpool_2, maxpool_1, x])

    x = convolution_batchNormalization(spp, filters=512, kernel_size=1, strides=1, activation="leaky_relu")
    x = convolution_batchNormalization(x, filters=1024, kernel_size=3, strides=2, activation="leaky_relu")
    ...
    x = convolution_batchNormalization(x, filters=256, kernel_size=2, strides=1, activation="leaky_relu")
    x = convolution_batchNormalization(x, filters=512, kernel_size=3, strides=2, activation="leaky_relu")
    x = convolution_batchNormalization(x, filters=256, kernel_size=1, strides=2, activation="leaky_relu")
    x = convolution_batchNormalization(x, filters=512, kernel_size=3, strides=1, activation="leaky_relu")
    ...
    x = convolution_batchNormalization(x, filters=256, kernel_size=2, strides=1, activation="leaky_relu")
    x = convolution_batchNormalization(x, filters=128, kernel_size=3, strides=2, activation="leaky_relu")
    x = convolution_batchNormalization(x, filters=256, kernel_size=3, strides=1, activation="leaky_relu")
    x = convolution_batchNormalization(x, filters=128, kernel_size=2, strides=1, activation="leaky_relu")
    x = convolution_batchNormalization(x, filters=256, kernel_size=3, strides=1, activation="leaky_relu")
